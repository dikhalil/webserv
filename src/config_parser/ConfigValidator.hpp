...
/*   Updated: 2025/12/16 22:22:21 by dikhalil         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class ConfigValidator
{
    public:
        ...
        static bool isValidPortRange(int port);
        ...
        static std::string getValidValue(const Tokenizer& tokenizer, const std::string& directive);

...
/*   Updated: 2025/12/17 19:17:13 by dikhalil         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class ConfigParser
{
    private:
        ...
        void parseStringList(const std::string& directive, std::vector<std::string>& list, void (*validate)(const std::string& val) = NULL);
        void parseSimpleString(const std::string& directive, std::string& target);
        void parseSimpleBool(const std::string& directive, int& target);
        void applyDefaults();
